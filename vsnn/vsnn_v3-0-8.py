...
arch = [
    ...
    *block_Inceptionx4Pool(name='cl4', bottom='cl3-pool', top='cl4-pool', s_filer="19x9",
                           ...
                           size=((2.5, 5, base_width + 7), (2.5, 5, base_width + 7), (2.5, 5, base_width + 7),
                                 (2.5, 5, base_width + 7)),
                           label=('4-4', '4-5', '4-6', '4-7'), gap_pool=True),

    # Bottleneck
    to_SoftMax("l5-fcl", bottleneck['fcl'], "(2,-5,0)", "(cl4-pool-east)", caption="FC5",
    ...
    # Decoder
    # EL4
    *block_ConvSkipInceptionx4(name="el4", bottom="l5-fcl", s_filer="19x9",
                               n_filer=(
                               ...
                               size=((2.5, 5, base_width + 7), (2.5, 5, 2 * (base_width + 7)),
                                     ...
                                     (2.5, 5, base_width + 7)),
                               label=("4-8", "4-1", "4-8", "4-9", "4-10", '4-11')),
