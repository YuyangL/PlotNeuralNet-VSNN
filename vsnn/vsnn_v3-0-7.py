...
cl3['incept3'] = 288
# Bottleneck
bottleneck['fcl1'] = 2223
bottleneck['fcl2'] = 4446
# Expansion
el3['incept1'] = 288
el3['incept2'] = 288
el3['incept3'] = 256
...
arch = [
    ...
    *block_Inceptionx3Pool(name='cl3', bottom='cl2-pool', top='cl3-pool', s_filer="39x19",
                           ...
                           label=('3-1', '3-2', '3-3'), gap_pool=True),

    # Bottleneck
    to_SoftMax("l4-fcl1", bottleneck['fcl1'], "(2,-5,0)", "(cl3-pool-east)", caption="FC4-1",
               width=2, height=2, depth=100),
    to_connection(
        "{}".format("cl3-pool"),
        "{}".format("l4-fcl1")),
    to_SoftMax("l4-fcl2", bottleneck['fcl2'], "(2,0,0)", "(l4-fcl1-east)", caption="FC4-2",
               width=2, height=2, depth=150),
    to_connection(
        "{}".format("l4-fcl1"),
        "{}".format("l4-fcl2")),
    ...
    # Decoder
    # EL3
    *block_ConvSkipInceptionx3(name="el3", bottom="l4-fcl2", s_filer="39x19",
                               n_filer=(
