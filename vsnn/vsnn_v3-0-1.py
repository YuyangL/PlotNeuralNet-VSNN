...
arch = [
    ...
    to_Conv(name='cl0-c2', s_filer="320x160", n_filer=cl0['conv2'], offset="(0,0,0)", to="(cl0-c1-east)",
    ...
    to_Conv(name='cl1-c1', s_filer="", n_filer=cl1['conv1'], offset="(2, -5, 0)", to="(cl0-c2-east)",
            width=base_width, height=20, depth=40, caption='C1-2'),
    to_Conv(name='cl1-c2', s_filer="160x80", n_filer=cl1['conv2'], offset="(0,0,0)", to="(cl1-c1-east)",
            width=base_width + 1, height=20, depth=40, caption='C1-3'),
    ...
    to_Conv(name='cl2-c1', s_filer="", n_filer=cl2['conv1'], offset="(2, -5, 0)", to="(cl1-pool-east)",
            width=base_width + 2, height=10, depth=20, caption='C2-4'),
    to_Conv(name='cl2-c2', s_filer="80x40", n_filer=cl2['conv2'], offset="(0,0,0)", to="(cl2-c1-east)",
            width=base_width + 3, height=10, depth=20, caption='C2-5'),
    ...
    # CL3
    *block_Inceptionx3Pool(name='cl3', bottom='cl2-pool', top='cl3-pool', s_filer="40x20",
    ...
    # Bottleneck
    *block_Inceptionx4(name='cl4', bottom='cl3-pool', s_filer="20x10",
                       n_filer=(
    ...
    # Decoder
    # EL3
    *block_UnconvSkipInceptionx3(name="el3", bottom="cl4-i4", s_filer="40x20",
                                 n_filer=(
    ...
    # EL2
    *block_UnconvSkipConvx2(name="el2", bottom="el3-i3", s_filer="80x40",
                            ...
                            label=("2-2", "2-2", "2-3", "2-4")),
    to_skip(of='cl2-c2', to='el2-skip', pos=4),

    # EL1
    *block_UnconvSkipConvx2(name="el1", bottom="el2-c2", s_filer="160x80",
                            ...
                            label=("1-3", "1-3", "1-5", "1-6")),
    to_skip(of='cl1-c2', to='el1-skip', pos=3),

    # EL0
    *block_UnconvSkipConv(name="el0", bottom="el1-c2", s_filer="320x160",
    ...
    to_Conv(name='el0-c2', s_filer="320x160", n_filer=el0['conv 1x1'], offset="(6,0,0)", to="(el0-c-east)",
            width=1, height=40, depth=80, caption='C0-8'),
    to_connection(
        "el0-c",
        "el0-c2"
    ),
